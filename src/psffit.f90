...
23 continue
   ...
   do i = nprev+1,nstars
      ...
      do irg = 1,rgmax
         ...
         PSF_Q =0.; PSF_Q4 = 0.
         call getshape(xc,yc,flux(i),rg(i),flag(i,irg),xedge,yedge,e,psm,psh, PSF_q, PSF_q4, .true.)
         !--Correct using RRG--!
         ...
         pRRG_Q2(i,1,irg) = RRG_Q(1,1)
         pRRG_Q2(i,2,irg) = RRG_Q(1,2)
         pRRG_Q2(i,3,irg) = RRG_Q(2,1)
         pRRG_Q2(i,4,irg) = RRG_Q(2,2)
...
108      format(3I7, 21e15.5)
   ...
   print *, 'Produced escatter plot', irg, irgmax
end do
print *, 'Finshed Loop'
...
!!$real*4         :: xedge,yedge
!!$real*4,intent(out)         :: q(2,2), q4(2,2,2,2)
!!$
!!$real*4                        :: denom
