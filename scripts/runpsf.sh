...
OUTDIR=/home/cajd/Size_Measurement/PSF/ #/disk1/ps1/cech/STAGES/RRG_update/OUTDATA/PSF
fitshead=a901-
fitstail=-sci.fits
...
do 
    ...
    $KSBDIR/psffit.a -nimage $COUNTER -image IM_CAT_LISTS/image.list.$obs_group -in IM_CAT_LISTS/cat.list.$obs_group -crit $STARCATDIR/$fitshead$i$starcattail -param KSBf90.param -pgopen /xwin -out $OUTDIR/STAGES_PSF.$obs_group.dat -RRGOut $OUTDIR/STAGES_RRG_PSF.$obs_group.dat -FWHM $OUTDIR/FWHM.$obs_group.dat
